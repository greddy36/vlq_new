...
if (CH == "Mu"):
    options = [
           ...
           ['mu_Train_NNscore', 10, "NNscore"],
           ['mu_Train_lepPt', 5, "LepPt"],
           ...
           ['mu_WJets_dphiJetmet', 5, "DPhi_Jet_Met"],
           ...
           ['mu_TTJets_dphiJetmet', 5, "DPhi_Jet_Met"],
           ...
           ['mu_PreSig_dphiJetmet', 5, "DPhi_Jet_Met"],
           ...
           ['mu_Train_leadjetPt', 10, "LeadJetPt"],
           ['mu_Train_met', 5, "Met"],
           ['mu_Train_st', 10, "ST"],
           ['mu_Train_stv2', 5, "ST_v2"],
           ['mu_Train_drLepleadjet', 10, "DR_Lep_leadJet"],
           ['mu_Train_ht', 10, "HT"],
           ['mu_Train_nbtagmedDeepFlv', 10, "NBTagMed_DeepFLV"],
           ['mu_Train_ncentralJets', 1, "NJetsCentral"],
           ['mu_Train_dphiLepmet', 5, "DPhi_Lep_Met"],
           ['mu_Train_dphiJetmet', 5, "DPhi_Jet_Met"],
           ['mu_Train_dphiLepleadjet', 5, "DPhi_Lep_leadJet"],
           ['mu_Train_drLepclosestJet', 10, "DR_Lep_ClosestJet"],
           ['mu_Train_bvswRatio', 10, "bVsW_ratio"],
           ['mu_Train_angleMujetMet',10, "Angle_MuJet_Met"],
           ['mu_Train_nfwdjets', 1, "NFwdJets"],
           ['mu_Train_mass_v2', 10, "Mass"],
           ['mu_Train_massT', 5, "MT"], 
           ['mu_Train_fwdjetpt', 5, "FwdJet_Pt"],
           ['mu_Train_fwdjeteta', 5, "FwdJet_Eta"],
           ['mu_Train_leadjetEta', 5, "LeadJetEta"],
           #['mu_Train_leadjetPhi', 5, "LeadJetPhi"],
           ['mu_Train_ht_over_leadjetpt', 1, "HT/LeadJet_pt"],'''
    ...
    options = [
           ...
           ['ele_Train_NNscore', 10, "NNscore"],
           ['ele_Train_lepPt', 5, "LepPt"],
           ...
           ['ele_WJets_dphiJetmet', 5, "DPhi_Jet_Met"],
           ...
           ['ele_TTJets_dphiJetmet', 5, "DPhi_Jet_Met"],
          ...
          ['ele_PreSig_lepEta', 5, "LepEta"],
           ...
           ['ele_PreSig_dphiJetmet', 5, "DPhi_Jet_Met"],
           ...
           '''['ele_Train_lepEta', 5, "LepEta"],
           ['ele_Train_leadjetPt', 10, "LeadJetPt"],
           ['ele_Train_met', 5, "Met"],
           ['ele_Train_st', 10, "ST"],
           ['ele_Train_stv2', 5, "ST_v2"],
           ['ele_Train_drLepleadjet', 10, "DR_Lep_leadJet"],
           ['ele_Train_ht', 10, "HT"],
           ['ele_Train_nbtagmedDeepFlv', 10, "NBTagMed_DeepFLV"],
           ['ele_Train_ncentralJets', 1, "NJetsCentral"],
           ['ele_Train_dphiLepmet', 5, "DPhi_Lep_Met"],
           ['ele_Train_dphiJetmet', 5, "DPhi_Jet_Met"],
           ['ele_Train_dphiLepleadjet', 5, "DPhi_Lep_leadJet"],
           ['ele_Train_drLepclosestJet', 10, "DR_Lep_ClosestJet"],
           ['ele_Train_bvswRatio', 10, "bVsW_ratio"],
           ['ele_Train_angleMujetMet',10, "Angle_MuJet_Met"],
           ['ele_Train_nfwdjets', 1, "NFwdJets"],
           ['ele_Train_mass_v2', 10, "Mass"],
           ['ele_Train_massT', 5, "MT"], 
           ['ele_Train_fwdjetpt', 5, "FwdJet_Pt"],
           ['ele_Train_fwdjeteta', 5, "FwdJet_Eta"],
           ['ele_Train_leadjetEta', 5, "LeadJetEta"],
           #['ele_Train_leadjetPhi', 5, "LeadJetPhi"],
           ['ele_Train_ht_over_leadjetpt', 1, "HT/LeadJet_pt"],'''
